...
export function Appbar() {
    return (
        ...
        <div className="appbar flex items-center space-x-1 md:space-x-8 shadow-md h-24">
           ...
           <Link to="/login"> <button className="button mt-2 text-lg border border-black-500 text-black font-bold py-2 px-4 rounded">Login</button></Link>
           <Link to="/singup"><button className="button mt-2 text-lg text-white bg-gray-800 font-bold py-2 px-4 rounded">Signup</button></Link>
            <button className="button mt-2 text-lg border border-black-600 text-blac font-bold py-2 px-4 rounded">
